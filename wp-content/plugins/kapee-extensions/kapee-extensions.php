...
if( !defined( 'KAPEE_EXTENSIONS_VERSION' ) ) {
    define( 'KAPEE_EXTENSIONS_VERSION', '1.1.0' ); // Version of plugin
}
...
require_once KAPEE_EXTENSIONS_DIR .'/inc/admin/ReduxCore/framework.php';
...
//add_action('init','kapee_plugin_test');
function kapee_plugin_test(){
	$obj_kp_Vctemplate = new kapeeVcTemplate();
	var_dump($obj_kp_Vctemplate->all_templates());
}