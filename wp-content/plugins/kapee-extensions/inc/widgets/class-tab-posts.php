			...
			<?php if( ( isset( $instance['tab_enable1'] ) || isset( $instance['tab_enable2'] ) || isset( $instance['tab_enable3'] ) ) && ( $instance['tab_enable1'] || $instance['tab_enable2'] || $instance['tab_enable3'] ) ){?>
				<ul class="nav nav-tabs" role="tablist">
					<?php if( $instance['tab_enable1'] ) { ?>
						<li class="nav-item">
							<a data-toggle="tab" class="nav-link active" href="#<?php echo esc_attr($widget_id);?>-tab1"><?php esc_html_e($instance['tab_title_1']);?></a>
						</li>
					<?php } ?>
					<?php if( $instance['tab_enable2'] ) { ?>
						<li class="nav-item">				
							<a data-toggle="tab" class="nav-link" href="#<?php echo esc_attr($widget_id);?>-tab2"><?php esc_html_e($instance['tab_title_2']);?></a>
						</li>
					<?php }?>
					<?php if( $instance['tab_enable3'] ) { ?>
						<li class="nav-item">					
							<a data-toggle="tab" class="nav-link" href="#<?php echo esc_attr($widget_id);?>-tab3"><?php esc_html_e($instance['tab_title_3']);?></a>
						</li>
					<?php }?>
				</ul>
